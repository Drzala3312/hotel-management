...
/**
 * [permissionReducer description]
 * @method  permissionReducer
 * @version [version]
 * @param   {any = initialState} state [description]
 * @param   {any} action [description]
 * @return  {[type]} [description]
 */
export function permissionReducer(state: any = initialState, action: any) {
    switch (action.type) {
        ...
        case types.LIST_PERMISSION_SUCCESS:
            return Object.assign({}, state, {
                ...state,
                isLoading: false,
                lastUpdated: Date.now(),
        ...
        case types.LIST_PERMISSION_FAILURE:
            return Object.assign({}, state, {
                ...state,
                isLoading: false,
                lastUpdated: Date.now(),
